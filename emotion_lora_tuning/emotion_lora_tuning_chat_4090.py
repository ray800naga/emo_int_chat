...
def main(emotion):
    try:
        ...
        wandb.init(
            project=f"4090_emotion_lora_tuning",
            name=f"emotion_lora_{config.model_name.split('/')[-1]}_{current_time}_{emotion}_4bit",
        )
        ...
        save_dir = f"/workspace/Emotion_Intent_Chat/emo_int_chat/emotion_lora_tuning/tuned_model/emotion_lora_{config.model_name.split('/')[-1]}_{current_time}_{emotion}_4bit"
